...
/**
 * Listener notified, eventually consistently, when bookmarks are placed or updated in an event stream.
 * <p>
 * Like {@link AppendListener}, it is the one kind of bookmark listener there is: told after the fact,
 * on a notification thread, never inside the bookmark operation — so its name carries no qualifier.
 * <p>
